...
import LeaveArticle from './pages/article/LeaveArticle.jsx';
import StudentFlatArticle from './pages/article/StudentFlatArticle.jsx';
import BreakContractArticle from './pages/article/BreakContractArticle.jsx';
import BorderArticle from './pages/article/BorderArticle.jsx';
import CommunalArticle from './pages/article/CommunalArticle.jsx';
            ...
            <Routes>
                <Route element={<RouteLayout />}>
                    ...
                    <Route path="/article">
                        ...
                        <Route path="leave" element={<LeaveArticle />} />
                        <Route path="student-flat" element={<StudentFlatArticle />} />
                        <Route path="break-contract" element={<BreakContractArticle />} />
                        <Route path="border" element={<BorderArticle />} />
                        <Route path="communal" element={<CommunalArticle />} />
                    </Route>
